class VueListeFilm {
  ...
  afficher() {
    ...
    for (var numeroFilm in this.listeFilmDonnee) {
      ...
      listeFilmItemHTMLRemplacement = listeFilmItemHTMLRemplacement.replace(/{Film.id}/g, this.listeFilmDonnee[numeroFilm].id)
      listeFilmItemHTMLRemplacement = listeFilmItemHTMLRemplacement.replace("{Film.titre}", this.listeFilmDonnee[numeroFilm].titre);
      listeFilmItemHTMLRemplacement = listeFilmItemHTMLRemplacement.replace("{Film.description}", this.listeFilmDonnee[numeroFilm].description);
